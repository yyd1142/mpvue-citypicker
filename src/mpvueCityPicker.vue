...
export default {
    ...
    methods: {
        ...
        initData() {
            if (wx.getStorageSync('MPVUE_CITY_DATA')) {
                const res = wx.getStorageSync('MPVUE_CITY_DATA');
                provinceData = res[0].data;
                cityData = res[1].data;
                areaData = res[2].data;
                this.init();
            } else {
                ...
                const p1 = http('https://fenqi.jiefanglu.com/installment/json/province.json');
                const p2 = http('https://fenqi.jiefanglu.com/installment/json/city.json');
                const p3 = http('https://fenqi.jiefanglu.com/installment/json/area.json');
                Promise.all([p1, p2, p3]).then(res => {
                    wx.setStorageSync('MPVUE_CITY_DATA', res);
                    provinceData = res[0].data;
                    cityData = res[1].data;
                    areaData = res[2].data;
                    this.init();
